...
elif choicestairs.lower()=="evade":choiceevade=input("Racked")
else: print("") 
if choicestairs is not ("run","fight", "evade"):
...
if choiceleft.lower()=="grab":choicegrab=input("A")
elif choiceleft.lower()=="look":choicelook=input("B")
elif choiceleft.lower()=="eating":choiceeating=input("C")
if choicestairs is not ("grab","look", "eating"):
    print("I'm sorry, but that wasn't one of the designed options, please type in one of the words that are in all caps, or maybe you might get lucky in picking something not in caps, who knows? But seriously, just pick one of the all caps words, you need to get lucky to find the secrets.")
